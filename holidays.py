# These two functions added to clear the terminal and present the code on the top of the screen
CLEAR = "\033[2J"
...
while True:
    try:
        ...
        # Calculate additional costs 
            ...
            print(f"\nTOTAL HOLIDAY COST:")
            print(f"-----------------------------------------\nTotal\t\t\t\t£{total+vat+insurance:.2f}")
        else:
            print("\nSorry, but the city you entered is not recognised.")
    ...
    # Return to the original question in case the user provides an invalid input
    except ValueError:
